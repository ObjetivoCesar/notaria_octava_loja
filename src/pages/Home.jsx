  ...
  const faqData = [
    {
      ...
      respuesta: "No en la Notaría Octava. Valoramos tu tiempo tanto como tú. Por eso implementamos un sistema de citas agendadas que te garantiza atención inmediata y sin esperas innecesarias. En lugar de perder tu mañana, recibirás una atención eficiente y enfocada, resolviendo lo necesario en una sola visita.",
    ...
    <div className="pt-16">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            Olvídate de trámites complicados, a pocas cuadras del parque central en la Notaría Octava 
        ...
        <div className="container mx-auto px-4 max-w-5xl text-center mb-12">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              ¿Por qué confiar en la Notaría Octava de Loja?
            </h2>
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
              En cada trámite, nuestra prioridad es que te sientas acompañado, informado y seguro. 
              Estos son los pilares que hacen diferente a la Notaría Octava.
            </p>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              de quienes ya vivieron una experiencia positiva en la Notaría Octava de Loja.
            </p>
          </motion.div>
