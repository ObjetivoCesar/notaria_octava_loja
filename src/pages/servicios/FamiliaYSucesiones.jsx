...
const FamiliaYSucesiones = () => {
  ...
  return (
    <div className="pt-16">
      <Helmet>
        <title>Familia y Sucesiones | Notaría Octava de Loja</title>
        <meta 
          name="description" 
        ...
        <div className="container-max px-4">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              Los asuntos familiares y sucesorios son momentos delicados que requieren sensibilidad, experiencia y un enfoque personalizado. En la Notaría Octava de Loja, entendemos la importancia de estos procesos en la vida de las personas y familias.
            </p>
