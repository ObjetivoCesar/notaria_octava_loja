      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Adultos mayores recibiendo atención preferencial en Notaría Octava"
        ...
        <div className="container-max relative z-10 text-center px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90 leading-relaxed max-w-3xl mx-auto">
              La experiencia y la sabiduría merecen nuestro máximo respeto y la mayor de las facilidades. En la Notaría Octava, entendemos que los adultos mayores en Loja no solo tienen derechos especiales garantizados por la ley, sino que también merecen una atención preferencial, paciente y totalmente clara.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                >
                  ...
                  <div className="mt-auto space-y-4">
                    <div className="flex items-start">
                      ...
                      <p className="text-red-50">Aplicación Directa: En la Notaría Octava, aplicamos rigurosamente estos descuentos y exoneraciones en todos los trámites que corresponde.</p>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-5 h-5 mt-1 mr-3 flex-shrink-0" />
