        ...
        <div className="container-max px-4 z-10 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Notaría Octava: Más de 20 Años Brindando Seguridad Jurídica en Loja
            </h1>
          </motion.div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  El alma de la Notaría Octava es su titular, la Dra. Lupe Patricia Quiñonez Rojas, una profesional con más de 20 años de trayectoria en el ejercicio notarial en Loja. Su nombre es sinónimo de integridad, claridad jurídica y compromiso con la comunidad.
                </p>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Equipo de la Notaría Octava</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <img 
                  ...
                  alt="Equipo de la Notaría Octava"
                  className="w-full h-full object-cover"
                />
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed">
                  En la Notaría Octava, actuamos guiados por valores firmes que garantizan tu tranquilidad en cada gestión:
                </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Te invitamos a conocer nuestras oficinas en el corazón de Loja. Descubre por qué tantos ciudadanos confían en la Notaría Octava para sus gestiones más importantes.
              </p>
